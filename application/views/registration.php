...
<div class="signup-form">
		...
		<?php echo form_open('Registration',['name'=>'userregistration','autocomplete'=>'off']);?>
...
<?php } ?>
				...
				<div class="">
	<?php echo form_input(['name'=>'name','class'=>'form-control','value'=>set_value('namename'),'placeholder'=>'Enter Name']);?>
...
<?php echo form_submit(['name'=>'insert','value'=>'Submit','class'=>'btn btn-success btn-lg btn-block']);?>
    ...
    <?php echo form_close();?>
	<div class="text-center"> <a href="<?php echo site_url('Signin');?>">Sign in</a></div>
</div>
</body>
</html>